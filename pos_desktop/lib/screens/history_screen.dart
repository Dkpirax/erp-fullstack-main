                                      ...
                                      subtitle: Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 16),
                                            Text('${order.items.length} items', style: const TextStyle(color: Colors.grey, fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                      children: [
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              ...order.items.map((item) => Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text('${item.quantity}x ', style: const TextStyle(color: Color(0xFFFF6B6B))),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text('LKR ${order.total.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFFFF6B6B))),
                                                ],
                                              ),
                                              const SizedBox(height: 16),
                                              SizedBox(
